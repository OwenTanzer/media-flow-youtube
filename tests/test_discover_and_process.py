...
def test_discovery_job_does_not_import_the_summary_stage():
    """Issue #20 deliberately moved summary work to summarize_backlog.py."""
    assert not hasattr(discover_and_process, "summarize_eligible")
